...
#define Constant_h
 ...
 ///CGFloat kQBRingThickness = 1.f;
// NSTimeInterval kQBAnswerTimeInterval = 60.f;
 //NSTimeInterval kQBRTCDisconnectTimeInterval = 30.f;

//NSString * kCallViewControllerID = @"CallViewController";
//NSString * kIncomingCallViewControllerID = @"IncomingCallViewController";
//NSString * kContainerViewControllerID = @"ContainerViewController";
